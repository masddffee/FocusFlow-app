...
5.  **Strict Output Format & Quality:**
    - **Include a 'planRationale' field:** Briefly explain the "why" behind your plan's structure, referencing their timeline and goals.
    - **Time Estimation Guidelines:** Calculate realistic durations based on task complexity:
      * Easy tasks: 20-45 minutes
      * Medium tasks: 30-90 minutes  
      * Hard tasks: 45-180 minutes
    - **Enhanced Content Structure:** Each subtask MUST include:
      * Clear learning objective (what will be achieved)
      * Specific execution method (how to start and proceed)
      * Concrete success criteria (how to know it's complete)
      * Actionable next steps (what to do after completion)
    - **Logical Progression:** Ensure prerequisites come before dependent skills.
    - **Action-Oriented Language:** Use imperative verbs and specific actions (e.g., "Build", "Create", "Practice", "Analyze")
    ...
    interface EnhancedSubtask {
      ...
      text: string;           // Detailed description with clear execution steps
